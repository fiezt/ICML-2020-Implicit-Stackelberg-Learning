...
def log_eigs(A_eigs, D_eigs, D_reg_eigs, J_eigs, SC_reg_eigs, SC2_reg_eigs):
    ...
    print('SC2 regularized minimum and maximum eigs:', SC2_reg_eigs)
    
    
def store_eigs(A_eig_data, D_eig_data, D_reg_eig_data, J_eig_data, SC_reg_eig_data, SC2_reg_eig_data, info_dir):
    ...
    np.savetxt(os.path.join(info_dir, 'SC2_reg_eigs.csv'), np.array(SC2_reg_eig_data), delimiter=',')